...
observation_df.to_csv('observations_short.csv',index=False)

pi0_Numerical=[sum([x[0]==0 for x in allTrueStates])/len(allTrueStates),sum([x[0]==1 for x in allTrueStates])/len(allTrueStates)]
